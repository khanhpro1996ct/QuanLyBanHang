                                        ...
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-header">
                                                <a href="{{route('chitietsanpham',$new->id)}}">
                                                    <img src="{{$new->image}}" height="250px" width="250px">
                                                </a>
                                            </div>
                                            ...
                                            <div class="single-item-caption">
                                                ...
                                                <a class="beta-btn primary" href="{{route('chitietsanpham',$new->id)}}">Xem chi tiết
                                        ...
                                        <div class="single-item">
                                            <div class="single-item-header">
                                                <a href="{{route('chitietsanpham',$spkm->id)}}">
                                                    <img src="{{$spkm->image}}" width="250px" alt=""
                                                         height="250px">
                                                </a>
                                            </div>
                                            <div class="single-item-body">
                                            ...
                                            <div class="single-item-caption">
                                                ...
                                                <a class="beta-btn primary"
                                                   href="{{route('chitietsanpham',$spkm->id)}}">Xem chi tiết
                                                    <i class="fa fa-chevron-right"></i>
                                                </a>
                                                <div class="clearfix"></div>
                                            </div>
